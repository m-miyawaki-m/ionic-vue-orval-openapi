...
- [1. 成果物×検証マトリクス](?path=/docs/test-strategy-1-成果物×検証マトリクス--docs) — §7連携
- [2. Unit層](?path=/docs/test-strategy-2-unit層--docs) — 定義/採用理由/実例
- [3. Component層](?path=/docs/test-strategy-3-component層--docs) — CT/browser比較 + visual baseline
- [4. Functional/Application層](?path=/docs/test-strategy-4-functional-application層--docs) — Playwright E2E
- [5. Release Candidate (Android)](?path=/docs/test-strategy-5-release-candidate-android--docs) — Maestro/Appium比較
- [9. ツール比較・採用理由（総覧）](?path=/docs/test-strategy-9-ツール比較・採用理由（総覧）--docs) — 全層の採用理由
